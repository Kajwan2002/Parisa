...
import { useMonthExpenses, useMonthSummary, useSettings } from '@/db/queries'
...
export function DashboardPage() {
  ...
  const greeting = hour < 5 ? 'Late night 🌙' : hour < 12 ? 'Good morning ☀️' : hour < 18 ? 'Hi there 🌷' : 'Good evening 🌸'
